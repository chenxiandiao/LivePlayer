...
import com.cxd.android.liveplayer.toolkit.rxjava.bus.annotation.Tag;
import com.cxd.android.liveplayer.toolkit.rxjava.bus.entity.DeadEvent;
...
import com.cxd.android.liveplayer.toolkit.rxjava.bus.finder.Finder;
...
//        KasLog.d("guohe", "reg, object = " + object);
...
//            KasLog.d("guohe", "post, clazz.getName() = " + clazz.getName());
            Set<SubscriberEvent> wrappers = getSubscribersForEventType(new EventType(tag, clazz));
//            KasLog.d("guohe", "post, wrappers = " + wrappers);

package com.cxd.android.liveplayer.widgets;
...
public class AutoBuildBackgroundDrawable extends LayerDrawable {
    ...
    protected ColorFilter _pressedFilter = new LightingColorFilter(Utils.mContext.getResources().getColor(R.color.hover_gray_color), 1);
